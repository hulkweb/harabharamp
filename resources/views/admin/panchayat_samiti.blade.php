    ...
    <div class="content-wrapper" style="width: auto !important;margin:auto !important">
        <div class="container">
                        ...
                        <tbody>
                            @foreach ($panchayats as $panchayat)
                                <tr>
                                    ...
                                    <td> <a href="/panchayat_samiti_edit/{{$panchayat->id}}" class="btn btn-success">View</a> </td>
            ...
            <form action="{{ route('panchayat_samiti_post') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="box_general padding_bottom">
                    <div class="header_box version_2">
                        <h2><i class="fa fa-file"></i>पंचायत एवं पंचायत समिति रजिस्ट्रेशन</h2>
                    </div>
                    @csrf
                    ...
                    <!-- /row-->
                    <p><button type="submit" id="submit" class="btn_1 medium">Register</button>
                    </p>
                </div>
                <!-- /box_general-->
                <!-- /box_general-->
                    ...
                    `<div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_${e}" class="form-control" placeholder="Name" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label> ${first} का फोन<span class="text-danger">*</span></label>
                                    <input type="number" name="phone_${e}" class="form-control" onkeyup="CheckValid(this.value,'errore_phone_${e}')" placeholder="Phone" required>
                                   <span id="errore_phone_${e}"></span>
                                </div>
                            </div>
                        </div>`
                );
