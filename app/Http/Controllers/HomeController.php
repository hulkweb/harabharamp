...
class HomeController extends Controller
{
    ...
    {
        $actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]/register?event=";

        $events = DB::table('events')->orderByDesc('created_at')->take(3)->get();
        $data = [
            'page_title' => 'Bhartiya Janta Yuva Morcha , Madhyapradesh',
            'events' => $events,
